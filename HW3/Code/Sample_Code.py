...
class Stump:
    ...
    def train_stump(self):
        ...
        # print '+++', data_points, feature_number
    ...
    def _information_gain(self, feature, boundary_value):
        ...
        # print '+++', len(self.training_data.features.T[feature]), feature, boundary_value
        ...
        # print '+++', greater_than_split_pos, greater_than_split_neg
