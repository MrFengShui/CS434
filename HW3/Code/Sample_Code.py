...
class Knn:
	...
	def get_cross_validation_error(self, k=1):
		total_error = 0
		print '+++', self.training_data.leave_out(0)
	...
	def _get_nearest_neighbors(self, test_instance):
		# print '+++', test_instance, self.training_data.features
...
def part_1():
	...
	csv = CsvPrinter('part_1.csv', labels)
	model = Knn(training_data)
	cv_err = model.get_cross_validation_error(k=1)
	# def _print_results():
		# print "---------------------------"
		# print "K-value: ", k
